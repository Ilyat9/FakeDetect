...
from app.core.deadline import Deadline, DeadlineExceeded, reset_deadline, set_deadline
from app.database import cache_get_result, cache_put_result, enqueue_retry, save_check
...
async def analyze(
    ...
    if suspect_phash and not request.headers.get("x-force-recheck"):
        ...
        if match:
            from app.forensics.phash import similarity_percent
...
async def _finalize_analyze_response(
    ...
    *,
    ...
    from app.core.verdict_engine import adjust_confidence_with_forensics, compute_final_score
    from app.database import cache_put_result, save_check, save_image_hash
...
async def analyze_deep(
    ...
    from app.aggregator import ImageAggregator
    from app.core import llm_gateway as gateway
    from app.services import tenancy
